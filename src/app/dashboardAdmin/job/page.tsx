...
export default function Home() {
  ...
  const handleCreateJob = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      router.push('/dashboardAdmin/job/list');
    } catch (error) {
      console.error(error);
    }
  };
        ...
        <div className="dashboard__content d-flex">
          ...
          <div className="dashboard__right">
              ...
              <div className="my__profile__tab radius-16 bg-white">
                <nav>
                  <div className="nav nav-tabs">
                    <a className="nav-link active" href="#info">{"Détails de l'Entreprise"}</a>
                  ...
                  <form onSubmit={handleCreateJob}>
                    <div className="info__field">
                      ...
                      <div className="row row-cols-1">
                        <div className="rt-input-group">
                          <label htmlFor="jd">{"Description de l'Emploi"}</label>
                          <textarea
                            className="form-control"
                            id="jd"
                      ...
                      <div className="row row-cols-sm-2 row-cols-1 g-3">
                        <div className="rt-input-group">
                          <label htmlFor="categoriejob">{"Categorie d'emploi"}</label>
                          <select
                            name="categoriejob"
                            id="categoriejob"
                            className="form-select"
                      ...
                      <div className="row row-cols-sm-2 row-cols-1 g-3">
                        ...
                        <div className="rt-input-group">
                          <label htmlFor="sm">Salaire Max</label>
                          <input
                            className="form-control"
                            type="text"
                            id="sm"
            ...
            <div className="d-flex justify-content-center mt-30">
              <p className="copyright">Copyright © 2024 Tous Droits Réservés par Tépé</p>
            </div>
          </div>
        </div>
      </div>
