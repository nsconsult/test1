...
export default function Home() { 
  ...
  const [jobsListing, setJobListing] = useState<JobsListing[]>([]);
  ...
  const laodsApplication = async () => {
    try {
      const applicationData = await apiService.getAllResources("applications/admin");
      const JobData = await apiService.getAllResources("job_listings/admin");
  ...
  <div className="dashboard__right">
    <div className="dash__content">
      ...
      <div className="dash__overview">
        <h6 className="fw-medium mb-30">Applications Overview</h6>
        <div className="overview__content">
          <div className="single__overview">
            ...
            <div className="content">
              <h5 className="lh-sm">{jobsListing.length}</h5>
              <p className="font-20">Job Posted</p>
            </div>
          </div>
          <div className="single__overview">
            <div className="icon">
              ...
              >
                <g clipPath="url(#application)">
                  <path
                    d="M24.2586 8.71582C24.5821 8.71582 24.8445 8.4535 24.8445 8.12988V1.75781C24.8445 0.788555 24.056 0 23.0867 0H1.75857C0.78931 0 0.00075531 0.788555 0.00075531 1.75781V28.2422C0.00075531 29.2114 0.78931 30 1.75857 30H23.0867C24.056 30 24.8445 29.2114 24.8445 28.2422V23.9255C24.8445 23.6019 24.5821 23.3395 24.2586 23.3395C23.935 23.3395 23.6726 23.6019 23.6726 23.9255V28.2422C23.6726 28.5653 23.4098 28.8281 23.0867 28.8281H1.75857C1.43548 28.8281 1.17263 28.5653 1.17263 28.2422V1.75781C1.17263 1.43473 1.43548 1.17188 1.75857 1.17188H23.0867C23.4098 1.17188 23.6726 1.43473 23.6726 1.75781V8.12988C23.6726 8.4535 23.935 8.71582 24.2586 8.71582Z"
                    fill="#34A853"
                  />
                  <path
                    d="M12.4223 3.16406C9.44988 3.16406 7.03166 5.58229 7.03166 8.55469C7.03166 10.0967 7.68264 11.4894 8.72397 12.4728C8.74348 12.4937 8.76422 12.5134 8.7869 12.5314C9.74613 13.4091 11.0227 13.9453 12.4222 13.9453C13.8217 13.9453 15.0983 13.409 16.0576 12.5314C16.0802 12.5134 16.101 12.4936 16.1205 12.4728C17.1619 11.4894 17.8129 10.0967 17.8129 8.55469C17.8129 5.58229 15.3947 3.16406 12.4223 3.16406ZM12.4223 12.7734C11.4655 12.7734 10.5825 12.4528 9.87399 11.914C10.389 11.0008 11.35 10.4297 12.4223 10.4297C13.4946 10.4297 14.4556 11.0008 14.9706 11.914C14.262 12.4528 13.3791 12.7734 12.4223 12.7734ZM11.4848 8.32031V7.93945C11.4848 7.42254 11.9054 7.00195 12.4223 7.00195C12.9392 7.00195 13.3598 7.42254 13.3598 7.93945V8.32031C13.3598 8.83723 12.9392 9.25781 12.4223 9.25781C11.9054 9.25781 11.4848 8.83723 11.4848 8.32031ZM15.8172 11.0556C15.3851 10.4147 14.7862 9.91629 14.0909 9.60855C14.3668 9.25189 14.5317 8.80512 14.5317 8.32031V7.93945C14.5317 6.77631 13.5854 5.83008 12.4223 5.83008C11.2591 5.83008 10.3129 6.77631 10.3129 7.93945V8.32031C10.3129 8.80512 10.4777 9.25189 10.7537 9.60855C10.0584 9.91629 9.45949 10.4147 9.02736 11.0556C8.51004 10.3553 8.20354 9.49025 8.20354 8.55469C8.20354 6.22846 10.0961 4.33594 12.4223 4.33594C14.7485 4.33594 16.641 6.22846 16.641 8.55469C16.641 9.49025 16.3345 10.3553 15.8172 11.0556Z"
                    fill="#34A853"
                  />
                  <path
                    d="M15.5863 25.6641H12.4223C12.0987 25.6641 11.8363 25.9264 11.8363 26.25C11.8363 26.5736 12.0987 26.8359 12.4223 26.8359H15.5863C15.9099 26.8359 16.1723 26.5736 16.1723 26.25C16.1723 25.9264 15.9099 25.6641 15.5863 25.6641Z"
                    fill="#34A853"
                  />
                  <path
                    d="M15.5863 21H7.26599C6.94244 21 6.68005 21.2623 6.68005 21.5859C6.68005 21.9096 6.94244 22.1719 7.26599 22.1719H15.5863C15.9099 22.1719 16.1722 21.9096 16.1722 21.5859C16.1722 21.2623 15.9099 21 15.5863 21Z"
                    fill="#34A853"
                  />
                  <path
                    d="M5.17772 17.492C5.0688 17.383 4.91763 17.3203 4.76294 17.3203C4.60878 17.3203 4.45761 17.383 4.34868 17.492C4.2397 17.601 4.177 17.7521 4.177 17.9062C4.177 18.0604 4.23964 18.2115 4.34868 18.3205C4.45825 18.4295 4.60878 18.4922 4.76294 18.4922C4.91763 18.4922 5.06821 18.4295 5.17772 18.3205C5.28671 18.2115 5.34946 18.0604 5.34946 17.9062C5.34946 17.7521 5.28677 17.601 5.17772 17.492Z"
                    fill="#34A853"
                  />
                  <path
                    d="M5.17772 21.1717C5.06821 21.0627 4.91763 21 4.76294 21C4.60878 21 4.45825 21.0627 4.34868 21.1717C4.2397 21.2807 4.177 21.4318 4.177 21.5859C4.177 21.74 4.23964 21.8912 4.34868 22.0002C4.45761 22.1092 4.60878 22.1719 4.76294 22.1719C4.91763 22.1719 5.0688 22.1092 5.17772 22.0002C5.28671 21.8912 5.34946 21.74 5.34946 21.5859C5.34946 21.4318 5.28677 21.2807 5.17772 21.1717Z"
                    fill="#34A853"
                  />
                  <path
                    d="M15.5863 17.3203H7.26599C6.94244 17.3203 6.68005 17.5826 6.68005 17.9062C6.68005 18.2299 6.94244 18.4922 7.26599 18.4922H15.5863C15.9099 18.4922 16.1722 18.2299 16.1722 17.9062C16.1722 17.5826 15.9099 17.3203 15.5863 17.3203Z"
                    fill="#34A853"
                  />
                  <path
                    d="M28.7697 7.63544C28.2004 7.30679 27.5372 7.21948 26.9022 7.38958C26.2673 7.55974 25.7365 7.96696 25.408 8.5362L18.0344 21.3075C17.994 21.3775 17.9685 21.4551 17.9595 21.5355L17.4405 26.1845C17.4147 26.4159 17.5283 26.6406 17.7298 26.757C17.8208 26.8095 17.9219 26.8355 18.0227 26.8355C18.1453 26.8355 18.2674 26.7971 18.3703 26.7214L22.1369 23.9473C22.202 23.8994 22.2565 23.8385 22.2969 23.7685L29.6704 10.9972C30.3489 9.82204 29.9448 8.31395 28.7697 7.63544ZM18.7537 24.9835L19.0247 22.5559L20.7206 23.535L18.7537 24.9835ZM21.575 22.6751L19.3423 21.386L25.2594 11.1374L27.4921 12.4264L21.575 22.6751ZM28.6555 10.4112L28.078 11.4116L25.8452 10.1225L26.4228 9.12214C26.5949 8.82395 26.8729 8.61067 27.2055 8.52155C27.5382 8.43237 27.8855 8.47819 28.1837 8.65034C28.4818 8.82249 28.6951 9.10046 28.7842 9.43304C28.8734 9.76561 28.8277 10.113 28.6555 10.4112Z"
                    fill="#34A853"
                  />
                </g>
                <defs>
            ...
            <div className="content">
              ...
              <p className="font-20">Application</p>
            </div>
          </div>
          <div className="single__overview">
            <div className="icon">
            ...
            <div className="content">
              ...
              <p className="font-20">Application Accepted</p>
            </div>
          </div>
          <div className="single__overview">
            <div className="icon">
            ...
            <div className="content">
              ...
              <p className="font-20">Application Rejected</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="applied__jobs">
        <h6 className="fw-medium mb-30">Recent Applicants</h6>
        <div className="short__list__candidate">
          {/* single item */}
          {/* <div className="single__shortlist__item">
            <div className="author__info">
              ...
              <div className="author__info__list">
                ...
                <button className="action__click">Approved</button>
              </div>
            </div>
            <div className="shortlist__action">
              <button className="action__item__long">
                ...
                >
                  <path
                    d="M4.71131 1.04615e-07C3.55909 1.04615e-07 2.54704 0.794667 2.23455 1.94533L0.0998472 9.80933C-0.0120051 10.2218 -0.0301641 10.6555 0.0467945 11.0765C0.123753 11.4975 0.293736 11.8942 0.543409 12.2356C0.793083 12.577 1.11565 12.8538 1.48582 13.0443C1.85599 13.2347 2.26368 13.3337 2.67692 13.3333H15.3231C15.7363 13.3337 16.144 13.2347 16.5142 13.0443C16.8843 12.8538 17.2069 12.577 17.4566 12.2356C17.7063 11.8942 17.8762 11.4975 17.9532 11.0765C18.0302 10.6555 18.012 10.2218 17.9002 9.80933L15.7655 1.94533C15.6137 1.38539 15.2896 0.892243 14.8424 0.541039C14.3953 0.189835 13.8496 -0.000162758 13.2887 1.04615e-07H4.71131ZM3.47293 2.30667C3.54868 2.02657 3.7107 1.77985 3.93429 1.60412C4.15787 1.42839 4.43075 1.33329 4.71131 1.33333H13.2887C13.5693 1.33329 13.8421 1.42839 14.0657 1.60412C14.2893 1.77985 14.4513 2.02657 14.5271 2.30667L16.6618 10.1707C16.7198 10.3847 16.7291 10.6098 16.6892 10.8283C16.6492 11.0468 16.561 11.2527 16.4315 11.4299C16.3019 11.6071 16.1345 11.7508 15.9425 11.8497C15.7504 11.9486 15.5388 12 15.3244 12H2.67563C2.46117 12 2.24962 11.9486 2.05754 11.8497C1.86547 11.7508 1.6981 11.6071 1.56855 11.4299C1.439 11.2527 1.35078 11.0468 1.31082 10.8283C1.27087 10.6098 1.28025 10.3847 1.33823 10.1707L3.47293 2.30667ZM4.49527 14.6667C4.32474 14.6667 4.1612 14.7369 4.04061 14.8619C3.92003 14.987 3.85229 15.1565 3.85229 15.3333C3.85229 15.5101 3.92003 15.6797 4.04061 15.8047C4.1612 15.9298 4.32474 16 4.49527 16H13.5034C13.674 16 13.8375 15.9298 13.9581 15.8047C14.0787 15.6797 14.1464 15.5101 14.1464 15.3333C14.1464 15.1565 14.0787 14.987 13.9581 14.8619C13.8375 14.7369 13.674 14.6667 13.5034 14.6667H4.49527Z"
                    fill="#939393"
                  />
                </svg>
                Create meeting
