...
export default function Home() {
  ...
  const filterSelect = async (id: number) => {    
    try {
      const applicationData = await apiService.getAllResources("applications");
      const filterjoblisting = applicationData.filter(
        (application: { job_listing_id: number }) => application.job_listing_id == id
      );
      setApplicationList(filterjoblisting);
    } catch (error) {
      console.error(error);
    }
  };
          ...
          <div className="dashboard__right">
            <div className="dash__content ">
              ...
              <div className="candidate__filter__area">
                <h6 className="font-20">Courte Liste des candidats</h6>
                  ...
                  >
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        aria-selected="false"
                      >
                        Acceptées: {applicationAppliedList.length}
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        aria-selected="false"
                      >
                        Rejetées: {applicationRemoveList.length}
                      </button>
                    </li>
                  </ul>
                </div>
              ...
              <div className="candidate__filter__area">
                <h6 className="font-20">Filtrer</h6>
  ...
  <span className="current">Emploi</span>
  <ul className="list">
    {jobsList.map((list) => (
      <li 
        onClick={() => filterSelect(list.id)} 
        key={list.id} 
        data-value={1} 
        className="option"
      >
        {list.title}
            ...
            <div className="d-flex justify-content-center mt-30">
              <p className="copyright">
                Copyright © 2024 Tous Droits Réservés par Tépé
              </p>
            </div>
          </div>
        </div>
