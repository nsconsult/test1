...
//   const [applicationList] = useState<Application[]>([]);
...
//     try {
//       await apiServices.deleteResource("job_listings", id);
//     } catch (error) {
//       console.error(error);
//     }
//   };
...
//       try {
//         const applicationData = await apiServices.getResourceById(
//           "applications",
//           id
//         );
//         if (applicationData) {
...
//               </div>
//               {/* sidebar menu end */}
//               <h6 className="fw-semibold mb-30">Candidature</h6>
...
//                     {/* single item */}
//                     <div key="" className="single__shortlist__item">
//                       <div className="author__info">
//                         <div className="author__meta">
//                           <div className="author__image">
//                             <img
//                               src={
//                                 application.user?.profile.profile_picture_path
//                               }
//                               alt=""
//                             />
//                           </div>
...
//                         <button
//                           onClick={() =>
//                             handleDownload(applicationList.resume_path)
//                           }
...
interface Application {
  user?: User; // rendre optionnel si l'utilisateur peut ne pas être présent
  id: number;
  user_id: number;
  job_listing_id: number;
  cover_letter: string;
...
export default function Home({ params }: { params: { show: string } }) {
  ...
  useEffect(() => {
    const loadApplication = async () => {
      try {
        const applicationData = await apiServices.getResourceById("applications", id);
        if (applicationData) {
          setApplication(applicationData);
        }
      } catch (error) {
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <div className="short__list__candidate">
                    {/* single item */}
                    {application && (
                      <><div key={application.id} className="single__shortlist__item">
                        <div className="author__info">
                          <div className="author__meta">
                            <div className="author__image">
                              <img
                                src={application.user?.profile.profile_picture_path}
                                alt="" />
                            </div>
                            <div className="author__name">
                              <h6 className="fw-semibold mb-1">
                        ...
                        <div className="shortlist__action">
                          <button
                            onClick={() => handleDownload(application.resume_path) // utilisation de resume_path de application
                            }
                            className="action__item__long"
                          >
                            <svg
                          ...
                          <div className="row row-cols-sm-2 row-cols-1 g-3">
                            ...
                            <div dangerouslySetInnerHTML={{ __html: application.cover_letter }} />
                          </div>
                        </div></>
                    )}
                  </div>
