...
export default function Home() {
  ...
  const handleUpdateProfile = async (userId:string) => {
    ...
    try {
      ...
      setSuccessMessage("Informations mis à jour avec succès new.");
      loadProfile();
    } catch (error) {
      console.error(error);
    }
  ...
  const handleSavePersonnalInfoUser = async (userid:string) => {
    ...
    try {
      ...
      setSuccessMessage("Informations mis à jour avec succès.");
      loadProfile();
    } catch (error) {
      console.error(error);
    }
        ...
        <div className="dashboard__content d-flex">
          ...
          <div className="dashboard__right">
            <div className="dash__content ">
              ...
              <div className="my__profile__tab radius-16 bg-white">
                ...
                <div className="my__details" id="info">
                  ...
                  <div className="info__field">
                    ...
                    <div className="row row-cols-sm-2 row-cols-1 g-3">
                      <div className="rt-input-group">
                        <label htmlFor="fd">Date de création</label>
                        <input
                      ...
                      <div className="rt-input-group">
                        <label htmlFor="cs">Taille de l'entreprise</label>
                        <input
                    ...
                    <div className="row row-cols-sm-2 row-cols-1 g-3">
                      <div className="rt-input-group">
                        <label htmlFor="cc">Catégories d'entreprises</label>
                      ...
                      <div className="rt-input-group">
                        <label htmlFor="pv">Public pour la vue du profil</label>
                        <select
                          name="pv"
                          id="pv"
                    ...
                    <button
                      onClick={()=>handleUpdateProfile(updateProfile.user_id)}
                      type="submit"
                      className="rts__btn fill__btn"
                    >
                      Enregistrer
              ...
              {/* social links */}
              <h6 className="fw-medium mt-4 mb-4">réseaux sociaux. </h6>
              <div
              ...
              {/* Member area end */}
              {/* address area */}
              <h6 className="fw-medium mt-4 mb-4">Address / Location</h6>
              <div
                ...
                <div className="info__field">
                  <div className="row row-cols-md-2 row-cols-1">
                    <div className="info__field">
                      ...
                      <div className="rt-input-group">
                        <label htmlFor="pr">Present Address</label>
                        <input
                          className="form-control"
                          type="text"
                          id="pr"
                      ...
                      <div className="info__field">
                        ...
                        <div className="gmap">
                          <div className="user__location">
                            <iframe src="https://maps.google.com/maps?width=100%25&height=600&hl=en&q=Open+The+Box,Lomé+Togo&ie=UTF8&iwloc=B&output=embed" />
                          </div>
                        </div>
                        <div className="rt-input-group">
